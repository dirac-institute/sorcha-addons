...
Implementation of the light curve generated by spinning ellipsoidal object.
...
.. image::
    ellipsoidal_lightcurve_example.png
   :width: 100%
   :loading: embed
...
To use this prescription, the **lc_model**  variable should be set to **ellipsoidal**
